...
/**
 * Tests for DualIndexedObservableCollection and its parent ObservableCollection to
 * make sure all the methods are working properly since this class is very important
...
public class ObservableCollectionTests{
	...
	/**
	 * Dummy class to extend from DualIndexedObservableCollection so that we can test
	 * its methods to see if it works.
	 */
